...
INSERT INTO clientes (apellidos, nombres, dni , claveacceso) VALUES
			('Grimes','Rick', 77082168 , '123'),
            ('Morgan','Jeffrey', 74859632 , '123');
...
INSERT INTO mascotas (idcliente , idraza, nombre, color, genero) VALUES
					(1, 1 , 'Destructora', 'Marron', 'Macho'),
                    (2, 2 , 'Negan', 'Negro' , 'Hembra') ;
...
DELIMITER $$
CREATE PROCEDURE spu_agregar_clientes
(
...
DELIMITER $$
CREATE PROCEDURE spu_agregar_mascotas
(
IN _idcliente INT,
IN _idraza INT ,
...
CALL spu_buscar_mascota(77082168);
...
CALL spu_buscar_cliente(77082168);
